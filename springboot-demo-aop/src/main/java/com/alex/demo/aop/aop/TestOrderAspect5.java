...
public class TestOrderAspect5 {
	...
	public void beforeMethod(JoinPoint jp) {
		System.out.println("执行Aspect5的Before");
	}
	...
	public void afterMethod(JoinPoint jp) throws IOException {
		System.out.println("执行Aspect5的After");
	}
	...
	public void afterReturningMethod(JoinPoint jp, Object result) {
		System.out.println("执行Aspect5的AfterReturning");
	}
	...
	public void afterThorwingMethod(JoinPoint jp, Exception e) {
		System.out.println("执行Aspect5的AfterThrowing");
	}
	...
	public Object aroundMethod(ProceedingJoinPoint jp) {
		...
		try {
			// 执行目标方法
			System.out.println("Aspect5 proceed之前");
			result = jp.proceed();
			System.out.println("Aspect5 proceed之后");
		} catch (Throwable e) {
			result = "error";
		}
		return result;
